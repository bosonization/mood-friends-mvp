  ...
  return (
    <main className="min-h-screen overflow-hidden px-6 py-7">
      ...
      <section className="mx-auto grid max-w-6xl items-center gap-10 py-12 lg:grid-cols-[0.98fr_1.02fr] lg:py-16">
        <div>
          <p className="mb-5 inline-flex rounded-full border border-orange-200 bg-white/70 px-4 py-2 text-sm font-bold text-orange-800 shadow-sm backdrop-blur">友達にだけ、そっと置ける。</p>
          <h1 className="max-w-3xl text-5xl font-black leading-[1.05] tracking-tight text-stone-950 sm:text-7xl">
            友達の
            <span className="block bg-gradient-to-r from-orange-500 via-pink-500 to-violet-600 bg-clip-text text-transparent">「今どんなノリ？」</span>
            がわかるアプリ
          </h1>
          <p className="mt-7 max-w-2xl text-base leading-8 text-stone-700 sm:text-lg">
            暇とは言いにくい。でも、今なら乗れるノリはある。eMooditionは、友達だけに「今なら乗れそうなこと」をそっと置けるアプリです。チャットやDMはなく、声をかけるきっかけだけをつくります。
          </p>
        ...
        <div className="relative" id="nori">
          ...
          <div className="relative overflow-hidden rounded-[2.3rem] border border-white/70 bg-white/75 p-3 shadow-2xl shadow-orange-100 backdrop-blur-xl">
            <img
              src="/nori-hero.png"
              alt="友達の今どんなノリ？がわかるeMooditionの紹介画像"
      ...
      <section className="mx-auto grid max-w-6xl gap-4 pb-8 md:grid-cols-3">
        {[
          ["ノリを置く", "今なにしてる？ではなく、今どんな誘いなら乗れそう？を置いておけます。"],
          ["友達だけ", "会員コードと相互承認で、既につながっている人だけに表示します。"],

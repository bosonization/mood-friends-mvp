      ...
      <section className="grid flex-1 items-center">
        <div className="rounded-[2.2rem] border border-white/70 bg-white/85 p-6 shadow-2xl shadow-orange-100 backdrop-blur-xl">
          ...
          <p className="mt-4 max-w-2xl leading-8 text-stone-700">
            ...
            登録後、この招待コードが記録され、招待した友達のLv5解放条件に反映されます。
          </p>
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            {user ? (
              <TransitionLink href="/friends" className="rounded-2xl bg-gradient-to-r from-orange-500 via-pink-500 to-violet-600 px-5 py-4 text-center font-black text-white shadow-lg shadow-pink-100">友達申請へ進む</TransitionLink>
            ) : (
              <TransitionLink href={`/login?invite=${inviteCode}`} className="rounded-2xl bg-gradient-to-r from-orange-500 via-pink-500 to-violet-600 px-5 py-4 text-center font-black text-white shadow-lg shadow-pink-100">登録・ログインする</TransitionLink>
            )}
